...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const objectExpect = createMenu(menu);
    objectExpect.order('coxinha');
    expect(objectExpect.consumption).toEqual(['coxinha']);
    ...
    // ```
    objectExpect.order('agua');
    objectExpect.order('sopa');
    objectExpect.order('sashimi');
    expect(objectExpect.consumption).toEqual([ 'coxinha', 'agua', 'sopa', 'sashimi' ]);
    ...
    expect(objectExpect.consumption).toEqual([ 'coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'coxinha', 'coxinha' ]);
    ...
    expect(objectExpect.pay()).toEqual(36.9 * 1.1);
